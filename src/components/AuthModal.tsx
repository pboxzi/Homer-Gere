      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative bg-white rounded-3xl shadow-2xl max-w-sm w-full overflow-hidden max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <div className="relative bg-[#1C1917] px-6 py-6 text-center">
              <button
                onClick={onClose}
                className="absolute top-3 right-3 w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/20 transition-all cursor-pointer"
              >
            ...
            <div className="px-5 py-4">
              <p className="text-[11px] font-bold text-[#57534E] uppercase tracking-wider mb-2.5">Member Benefits</p>
            ...
            <div className="px-5 pb-5 space-y-2">
              <button
                ...
                className="w-full bg-[#1C1917] hover:bg-[#292524] text-white text-xs font-medium py-3 rounded-xl transition-all cursor-pointer inline-flex items-center justify-center gap-2"
              >
                Sign In
              ...
              <button
                ...
                className="w-full bg-[#A6852F] hover:bg-[#8B6F1F] text-white text-xs font-medium py-3 rounded-xl transition-all cursor-pointer"
              >
                Apply for Membership
              </button>
              <button
                onClick={onClose}
                className="w-full text-[#57534E] text-[11px] hover:text-[#1C1917] transition-colors cursor-pointer py-2.5"
              >
                Cancel
              </button>
            </div>
