      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div id="hero-container" className="relative rounded-[2rem] overflow-hidden bg-[#F3F1ED] min-h-[500px] sm:min-h-[600px] lg:min-h-[720px] w-full flex flex-col justify-between group transition-all duration-300">
          ...
          <div className="relative lg:absolute top-0 right-0 w-full lg:w-[55%] h-[280px] sm:h-[380px] lg:h-full shrink-0">
            <img src={heroImage || IMAGES.homerGqLifestyleStudio} alt="Homer Gere - Editorial Portrait" referrerPolicy="no-referrer" className="w-full h-full object-cover object-top lg:object-top transition-transform duration-1000 ease-out group-hover:scale-[1.01]" />
          ...
          <div className="relative z-10 p-6 sm:p-10 md:p-14 lg:p-16 lg:pt-48 lg:pb-16 w-full lg:w-[48%] flex flex-col items-start justify-between h-full space-y-6 lg:space-y-0">
