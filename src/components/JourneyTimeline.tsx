    ...
    <section id="journey" className="py-24 sm:py-32 bg-[#FAF9F7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative py-4">
          {/* Connecting Line */}
          <div className="absolute top-6 left-4 right-4 h-[1px] bg-[#E8E5DF] z-0 hidden md:block" />
        ...
        <div className="mt-10 pt-8 bg-[#F3F1ED]/60 rounded-[1.5rem] p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 transition-all duration-500">
          ...
          <button
            ...
            className="text-xs font-medium text-[#C9A84C] hover:text-[#B8983A] transition-colors duration-300 shrink-0 focus:outline-none cursor-pointer"
          >
