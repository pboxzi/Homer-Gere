      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-[2rem] overflow-hidden min-h-[560px] lg:min-h-[640px]">
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16 h-full flex flex-col justify-between max-w-3xl">
            ...
            <div className="pt-6">
              <button onClick={() => onDiscoverMore(FEATURED_PROJECT.id)} className="inline-flex items-center gap-2.5 bg-[#C9A84C] hover:bg-[#B8983A] text-white font-medium text-sm px-7 py-3.5 rounded-2xl transition-all duration-300 transform active:scale-95 hover:shadow-lg hover:shadow-[#C9A84C]/25 group focus:outline-none cursor-pointer">
