    ...
    <div className="space-y-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
        ...
        <div className="space-y-2">
          {FAQ_ITEMS.map((faq, i) => (
            <div key={i} className="rounded-2xl border border-[#E8E5DF]/60 bg-white overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
        ...
        <AnimatePresence>
          {showForm && (
            <motion.div className="rounded-2xl border border-[#E8E5DF]/60 bg-white p-5 space-y-3 mb-4" initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }}>
              {submitted ? (
                ...
                <>
                  ...
                  <button onClick={handleSubmit} className="inline-flex items-center gap-2 bg-[#1C1917] hover:bg-[#292524] text-white text-sm font-medium px-5 py-2.5 rounded-2xl transition-all cursor-pointer">
        ...
        <div>
          ...
          <div className="space-y-3">
            {helpTickets.map((ticket, i) => (
              <motion.div key={ticket.id} className="rounded-2xl border border-[#E8E5DF]/60 bg-white overflow-hidden" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 + i * 0.04 }}>
                    ...
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }}>
                      <div className="px-4 pb-4 space-y-3 border-t border-[#E8E5DF]/40">
                        ...
                        <div className="flex items-center gap-2 pt-1">
                          ...
                          <button onClick={() => handleReply(ticket.id)} className="w-9 h-9 rounded-xl bg-[#1C1917] text-white flex items-center justify-center hover:bg-[#292524] transition-colors cursor-pointer">
