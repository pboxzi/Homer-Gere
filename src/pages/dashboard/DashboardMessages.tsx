    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          />
          <button onClick={handleSendReply} className="w-10 h-10 rounded-xl bg-[#A6852F] text-white flex items-center justify-center hover:bg-[#8B6F1F] shadow-md shadow-[#A6852F]/30 transition-colors cursor-pointer">
    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => setShowNew(!showNew)} className="inline-flex items-center gap-2 text-xs font-medium text-[#A6852F] hover:text-[#8B6F1F] transition-colors cursor-pointer bg-[#A6852F]/22 shadow-sm shadow-[#A6852F]/22 px-3 py-1.5 rounded-xl">
      ...
      <AnimatePresence>
        {showNew && (
          <motion.div className="rounded-2xl border border-[#A6852F]/38 bg-white p-5 space-y-3 shadow-sm shadow-[#A6852F]/18" initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }}>
            ...
            <div className="flex gap-2">
              <button onClick={handleCreate} className="inline-flex items-center gap-2 bg-[#A6852F] hover:bg-[#8B6F1F] shadow-md shadow-[#A6852F]/30 text-white text-sm font-medium px-5 py-2.5 rounded-2xl transition-all cursor-pointer">
          ...
          enquiries.map((enq, i) => (
            <motion.button
              ...
              className={`w-full flex items-center gap-4 p-4 rounded-2xl border text-left transition-all duration-500 cursor-pointer ${
                enq.status === 'open' ? 'border-[#A6852F]/90 bg-[#A6852F]/22 shadow-md shadow-[#A6852F]/22' : 'border-[#A6852F]/38 bg-white hover:border-[#A6852F]/55 shadow-sm shadow-[#A6852F]/18'
              }`}
