        ...
        <>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-[#A6852F]/10">
                {paged.map(sub => {
                  ...
                  return (
                    <tr key={sub.id} className="hover:bg-[#A6852F]/5 transition-colors">
          ...
          <div className="md:hidden space-y-3">
            {paged.map(sub => {
              const sc = STATUS_CONFIG[sub.status] || STATUS_CONFIG.pending;
              return (
                <div key={sub.id} className="bg-white rounded-xl border border-[#A6852F]/20 p-4 shadow-sm hover:shadow-lg transition-all duration-500">
