...
interface GalleryExploreProps {
  onNavigate: (path: string) => void;
}

export const GalleryExplore: React.FC<GalleryExploreProps> = ({ onNavigate }) => {
  ...
  const CARDS = [
    {
      id: 'media',
      title: 'Media',
      description: 'Explore official videos, trailers, and behind-the-scenes footage.',
    ...
    },
    {
      id: 'journal',
      title: 'Journal',
      description: 'Read personal insights, behind-the-scenes stories, and career updates.',
