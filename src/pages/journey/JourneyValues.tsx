        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
          {VALUES.map((value, idx) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-[#C8A96A]/10 text-[#C8A96A] flex items-center justify-center mb-6 group-hover:bg-[#C8A96A] group-hover:text-white transition-all duration-500 group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-[#C8A96A]/20">
                  <Icon className="w-7 h-7" />
                </div>

                <h3 className="text-lg font-editorial font-bold text-[#111827] group-hover:text-[#C8A96A] transition-colors duration-300 mb-3">
                  {value.title}
                </h3>
