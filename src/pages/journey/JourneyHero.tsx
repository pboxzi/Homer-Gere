    ...
    <section className="relative h-[75vh] min-h-[600px] bg-[#F8F5EF] overflow-hidden pt-20">
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
        <div className="max-w-xl lg:max-w-2xl space-y-6 sm:space-y-8">
          ...
          <motion.h1
            className="text-5xl sm:text-6xl lg:text-7xl font-editorial font-bold text-[#111827] tracking-tight leading-[1.02]"
          ...
          >
            Every great career begins with a single step. Explore the experiences, milestones,
            and moments that continue to shape Homer's story.
          </motion.p>
